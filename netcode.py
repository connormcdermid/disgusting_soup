...
def get_course_code(dept: str) -> str:
    ...
    match dept:
        ...
        case "Creative Writing" | "CREW": return "001A"
        case "Criminology" | "CRIM": return "001B"
        case "Dental Hygiene" | "DHYG": return "001C"
        case "Digital Media" | "DIGI": return "001D"
        case "Early Childhood Education and Care" | "ECEC": return "001E"
        ...
        case "Event Management" | "CONV": return "001K"
        ...
        case "Health Sciences & Human Services" | "HHS" : return "000O"
        ...
        case "Linguistics" | "LING": return "000J" # No courses offered this term
        ...
        case "Social Science Interdisciplinary" | "SSID": return "002S"
        ...
        case "Study Skills" | "STSK": return "002X" # I couldn't find a course code for this so I added the one that matches mainPage.py
